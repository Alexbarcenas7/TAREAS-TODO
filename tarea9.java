...
public class main {
    public static void main(String[] args) {
        ...
        System.out.printf("Altura respecto al lado A: \n", altura);
        ...
        System.out.printf("Punto medio del lado AB: (%.2f, %.\n", puntoMedioAB[0], puntoMedioAB[1]);
        System.out.printf("Punto medio del lado BC: (%.2f, %.\n", puntoMedioBC[0], puntoMedioBC[1]);
        System.out.printf("Punto medio del lado CA: (%.2f, %.\n", puntoMedioCA[0], puntoMedioCA[1]);
